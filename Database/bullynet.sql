...
--
-- Host: localhost
-- Generation Time: Dec 01, 2021 at 06:31 AM
...
-- Database: `bullynet`
--
CREATE DATABASE IF NOT EXISTS `bullynet` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `bullynet`;
...
(3, 'Ashok', 'Ashok123@gmail.com', 'Ashok', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(4, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(5, 'Mohan', 'Mohan123@gmail.com', 'Mohan', '9535866270', 'India', 'Karnataka', 'Bangalore');
...
(23, 'Naive Bayes', '86.06011700625378'),
(24, 'SVM', '88.19850716158967'),
(25, 'Logistic Regression', '89.93342747629615'),
(26, 'Decision Tree Classifier', '88.58180351018761');
...
(18, 'Hate', '11.11111111111111'),
(19, 'Cyberbulling', '66.66666666666666'),
(20, 'Non Cyberbulling', '22.22222222222222');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_tweet_prediction_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_tweet_prediction_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Tweet_Message` varchar(30000) NOT NULL,
  `Prediction_Type` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=27 ;

--
-- Dumping data for table `remote_user_tweet_prediction_model`
--

INSERT INTO `remote_user_tweet_prediction_model` (`id`, `Tweet_Message`, `Prediction_Type`) VALUES
(16, '8220 cause i m tired of you big bitches coming for us skinny girls 8221', 'Cyberbulling'),
(17, 'fuck no that bitch dont even suck dick 128514 128514 128514 the kermit videos bout to fuck ig up', 'Cyberbulling'),
(18, 'lemmie eat a oreo amp do these dishes one oreo lol', 'Non Cyberbulling'),
(19, 'baby24 thunduh alsarabsss hes a beaner smh you can tell hes a mexican', 'Hate'),
(20, 'how bout them cowboys shutup pussy', 'Cyberbulling'),
(21, 'as long as the lakers trash from now on i could careless and that s real cc hahaha', 'Non Cyberbulling'),
(22, 'shut yo bitch ass up https t co iemn1u0gm5 128557 128514', 'Cyberbulling'),
(23, 'palomino52 i think worst advice i gave you was don t be a pussy and speed up lol', 'Cyberbulling'),
(24, 'probz i m hungry but ionn wanna spend my money on food 128530 broke hoe problems 128514 128514 128514 128128', 'Cyberbulling'),
(25, 'i ll slit your throat neck http t co chffsdeddd', 'Non Cyberbulling'),
(26, 'i m a funky ass honkey s shout out to tonight before cabaret 128514 jt2020tour', 'Cyberbulling');
