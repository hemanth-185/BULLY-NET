...
urlpatterns = [
    ...
    url(r'^Find_Tweet_Message_Prediction_Ratio/$', serviceprovider.Find_Tweet_Message_Prediction_Ratio, name="Find_Tweet_Message_Prediction_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Tweet_Mesage_Predict_Type/$', serviceprovider.View_Tweet_Mesage_Predict_Type, name="View_Tweet_Mesage_Predict_Type"),
    url(r'^Download_Cyber_Bullying_Prediction/$', serviceprovider.Download_Cyber_Bullying_Prediction, name="Download_Cyber_Bullying_Prediction"),
